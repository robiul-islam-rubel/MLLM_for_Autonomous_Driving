...
class ConversationDataset(Dataset):
    def __init__(self,
        ...
        self.label_dir = os.path.join(root_dir,
                                      'labels')  # can be change to labels_en or labels_zh in SFT-311K dataset
...
def main():
    ...
    tokenizer = AutoTokenizer.from_pretrained(args.model_path, trust_remote_code=True,cache_dir='/scratch/miislam/cache')
    model = AutoModelForCausalLM.from_pretrained(args.model_path, torch_dtype=args.torch_type, trust_remote_code=True,cache_dir='/scratch/miislam/cache')
